question:-1  //we have to it is false or true
// let sum = 0.1+0.2;
// if(sum==0.3){
//   console("True")
// }else {
...
question:-2  //we have to check it is false ot true
...
question:-5  // we want to achive 15 to this code how can achive 
// function multiply (num1,num2){
// }
...
//   triple (3) //15
  ...
  question:-6  //if we want to achieve  200 and 15 with the help of this code 
// function multiply (num1,num2){
// if(num2==undefined){
//   return function triple(num3){
//     console.log(num3*num1)
...
question:-8    /*we wanted to print 1 to 5 in  a interval of 1 second  */  
  // for (let i=1;i<=5;i++)
  // setTimeout (()=>{   
  // console.log(i)
